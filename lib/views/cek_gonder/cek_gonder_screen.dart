        ...
        child: Column(
          ...
          children: [
            ...
            _buildGlassContainer(
              ...
              child: Column(
                children: [
                  _buildInput(controller: _adSoyadController, label: isEn ? "Full Name" : "Ad Soyad", icon: Icons.person_outline, isEn: isEn),
                  ...
                  _buildInput(controller: _emailController, label: isEn ? "Email" : "E-posta", icon: Icons.email_outlined, keyboardType: TextInputType.emailAddress, isEn: isEn),
                  _buildInput(controller: _telNoController, label: isEn ? "Phone" : "Telefon", icon: Icons.phone_outlined, keyboardType: TextInputType.phone, isEn: isEn),
                ],
              ),
            ),
            const SizedBox(height: 35),
