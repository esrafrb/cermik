/// Türkiye'nin 81 ilinin tüm ilçeleri
class TurkeyDistricts {
  static const Map<String, List<String>> ilceler = {
  ...
  /// İl adına göre ilçe listesini döndürür
  static List<String> getDistricts(String city) {
    return ilceler[city] ?? [];
  }

  /// Tüm il isimlerini alfabetik sırayla döndürür
  static List<String> get cities => ilceler.keys.toList()..sort();
}
